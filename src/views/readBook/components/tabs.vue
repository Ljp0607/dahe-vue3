<template>
  <div class="tabs">
    <div class="search">
      <img
        @click="changeText"
        src="https://imgcdn.dahebao.cn/20230526/20230526102307209276.png"
      />
      <input type="text" v-model="data.content" placeholder="请输入姓名搜索" />
      <!-- <van-button  class="search_button">搜索</van-button> -->
    </div>
    <van-tabs
