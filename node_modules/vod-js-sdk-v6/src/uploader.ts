...
class Uploader extends EventEmitter implements UploaderOptions {
  ...
  constructor(params: UploaderOptions) {
    ...
    this.cosStrategy = this.getCosStrategy(params);
  ...
  getCosStrategy(params: UploaderOptions) {
    const sourceData: CosStrategyProps = {
      ...
      Object.assign(
        {
          getAuthorization: async function(
            ...
            const safeExpireTime =
              (applyData.tempCertificate.expiredTime - applyData.timestamp) *
              0.9;
