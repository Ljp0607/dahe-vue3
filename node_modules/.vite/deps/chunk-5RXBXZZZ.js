...
var [name12, bem12] = createNamespace("sticky");
var stickyProps = {
  zIndex: numericProp,
...
var Sticky = withInstall(stdin_default14);

// node_modules/vant/es/swipe/Swipe.mjs
var [name13, bem13] = createNamespace("swipe");
var swipeProps = {
  loop: truthProp,
  width: numericProp,
  height: numericProp,
...
var Swipe = withInstall(stdin_default15);
...
var [name14, bem14] = createNamespace("tab");
...
var [name15, bem15] = createNamespace("tabs");
...
var [name16, bem16] = createNamespace("tabs");
var tabsProps = {
...
var stdin_default18 = defineComponent({
  ...
  setup(props, {
    ...
    const renderNav = () => children.map((item, index) => createVNode(stdin_default16, mergeProps({
      "key": item.id,
      "id": `${id}-${index}`,
    ...
    }) : renderHeader(), createVNode(stdin_default17, {
      "ref": contentRef,
...
var [name17, bem17] = createNamespace("swipe-item");
...
var SwipeItem = withInstall(stdin_default19);
...
var [name18, bem18] = createNamespace("tab");
...
var Tab = withInstall(stdin_default20);

// node_modules/vant/es/tabs/index.mjs
var Tabs = withInstall(stdin_default18);

// node_modules/vant/es/picker/utils.mjs
var [name19, bem19, t] = createNamespace("picker");
...
var [name20] = createNamespace("picker-toolbar");
...
var stdin_default21 = defineComponent({
  ...
  setup(props, {
    ...
    const renderTitle = () => {
      ...
      if (props.title) {
        return createVNode("div", {
          "class": [bem19("title"), "van-ellipsis"]
        }, [props.title]);
      }
    };
    ...
    const renderCancel = () => {
      ...
      return createVNode("button", {
        "type": "button",
        "class": [bem19("cancel"), HAPTICS_FEEDBACK],
        "onClick": onCancel
    ...
    const renderConfirm = () => {
      ...
      return createVNode("button", {
        "type": "button",
        "class": [bem19("confirm"), HAPTICS_FEEDBACK],
        "onClick": onConfirm
...
var [name21, bem20] = createNamespace("picker-group");
var PICKER_GROUP_KEY = Symbol(name21);
...
var stdin_default22 = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      return createVNode("div", {
        "class": bem20()
      }, [createVNode(stdin_default21, mergeProps(props, {
        "onConfirm": onConfirm,
        "onCancel": onCancel
...
var [name22, bem21] = createNamespace("picker-column");
var PICKER_KEY = Symbol(name22);
...
var stdin_default24 = defineComponent({
  ...
  setup(props, {
    ...
    const renderColumnItems = () => currentColumns.value.map((options, columnIndex) => createVNode(stdin_default23, {
    ...
    const renderMask = (wrapHeight) => {
      if (hasOptions.value) {
        ...
        return [createVNode("div", {
          ...
          "class": [BORDER_UNSET_TOP_BOTTOM, bem19("frame")],
          "style": frameStyle
        }, null)];
      }
    };
    ...
    const renderToolbar = () => {
      if (props.showToolbar && !parent) {
        return createVNode(stdin_default21, mergeProps(pick(props, pickerToolbarPropKeys), {
          "onConfirm": confirm,
          "onCancel": cancel
...
export {
  ...
  version,
  install,
  stdin_default111 as stdin_default
};
//# sourceMappingURL=chunk-5RXBXZZZ.js.map
