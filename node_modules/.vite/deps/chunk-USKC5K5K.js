...
var ActionBarIcon = withInstall(stdin_default2);
...
var ActionSheet = withInstall(stdin_default3);
...
var [name3, bem3] = createNamespace("sticky");
var stickyProps = {
  zIndex: numericProp,
...
var Sticky = withInstall(stdin_default4);

// node_modules/vant/es/swipe/Swipe.mjs
var [name4, bem4] = createNamespace("swipe");
var swipeProps = {
  loop: truthProp,
  width: numericProp,
  height: numericProp,
...
var Swipe = withInstall(stdin_default5);
...
function useId() {
  ...
  const { name: name93 = "unknown" } = (vm == null ? void 0 : vm.type) || {};
  if (false) {
    return name93;
  }
  return `${name93}-${++current}`;
}
...
var [name5, bem5] = createNamespace("tab");
...
var [name6, bem6] = createNamespace("tabs");
...
var [name7, bem7] = createNamespace("tabs");
var tabsProps = {
...
var stdin_default8 = defineComponent({
  ...
  setup(props, {
    ...
    const renderNav = () => children.map((item, index) => createVNode(stdin_default6, mergeProps({
      "key": item.id,
      "id": `${id}-${index}`,
    ...
    }) : renderHeader(), createVNode(stdin_default7, {
      "ref": contentRef,
...
var [name8, bem8] = createNamespace("swipe-item");
...
var SwipeItem = withInstall(stdin_default9);
...
var [name9, bem9] = createNamespace("tab");
...
var Tab = withInstall(stdin_default10);

// node_modules/vant/es/tabs/index.mjs
var Tabs = withInstall(stdin_default8);

// node_modules/vant/es/picker/utils.mjs
var [name10, bem10, t] = createNamespace("picker");
...
var [name11] = createNamespace("picker-toolbar");
...
var stdin_default11 = defineComponent({
  ...
  setup(props, {
    ...
    const renderTitle = () => {
      ...
      if (props.title) {
        return createVNode("div", {
          "class": [bem10("title"), "van-ellipsis"]
        }, [props.title]);
      }
    };
    ...
    const renderCancel = () => {
      ...
      return createVNode("button", {
        "type": "button",
        "class": [bem10("cancel"), HAPTICS_FEEDBACK],
        "onClick": onCancel
    ...
    const renderConfirm = () => {
      ...
      return createVNode("button", {
        "type": "button",
        "class": [bem10("confirm"), HAPTICS_FEEDBACK],
        "onClick": onConfirm
...
var [name12, bem11] = createNamespace("picker-group");
var PICKER_GROUP_KEY = Symbol(name12);
...
var stdin_default12 = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      return createVNode("div", {
        "class": bem11()
      }, [createVNode(stdin_default11, mergeProps(props, {
        "onConfirm": onConfirm,
        "onCancel": onCancel
...
var [name13, bem12] = createNamespace("picker-column");
...
var stdin_default14 = defineComponent({
  ...
  setup(props, {
    ...
    const renderColumnItems = () => currentColumns.value.map((options, columnIndex) => createVNode(stdin_default13, {
    ...
    const renderMask = (wrapHeight) => {
      if (hasOptions.value) {
        ...
        return [createVNode("div", {
          ...
          "class": [BORDER_UNSET_TOP_BOTTOM, bem10("frame")],
          "style": frameStyle
        }, null)];
      }
    };
    ...
    const renderToolbar = () => {
      if (props.showToolbar && !parent) {
        return createVNode(stdin_default11, mergeProps(pick(props, pickerToolbarPropKeys), {
          "onConfirm": confirm,
          "onCancel": cancel
...
var stdin_default16 = defineComponent({
  ...
  setup(props, {
    ...
    const renderLabel = () => {
      ...
      if (showLabel) {
        return createVNode("div", {
          "class": [bem14("label"), props.labelClass]
    ...
    const renderTitle = () => {
      ...
      if (slots.title || isDef(props.title)) {
        ...
        return createVNode("div", {
          "class": [bem14("title"), props.titleClass],
    ...
    const renderValue = () => {
      ...
      if (hasValue) {
        return createVNode("div", {
          "class": [bem14("value"), props.valueClass]
...
var stdin_default19 = defineComponent({
  ...
  setup(props, {
    ...
    return () => createVNode(Popup, mergeProps({
      "class": [bem17([props.position, props.wordBreak === "normal" ? "break-normal" : props.wordBreak, {
    ...
    return () => {
      ...
      return createVNode(Form, {
        ...
        default: () => {
          ...
          }, null), [[vShow, props.showArea]]), createVNode(stdin_default21, {
...
var [name23, bem22] = createNamespace("tag");
var tagProps = {
  size: String,
  mark: Boolean,
  show: truthProp,
  ...
  setup(props, {
    ...
    const renderTag = () => {
      ...
      const CloseIcon = closeable && createVNode(Icon, {
        "name": "cross",
        "class": [bem22("close"), HAPTICS_FEEDBACK],
        "onClick": onClose
      }, null);
      return createVNode("span", {
        "style": getStyle(),
...
var Tag = withInstall(stdin_default24);
...
var stdin_default25 = defineComponent({
  ...
  setup(props, {
    ...
    const iconRef = ref();
    const getParentProp = (name93) => {
      if (props.parent && props.bindGroup) {
        return props.parent.props[name93];
      }
    };
...
var [name24, bem23] = createNamespace("radio");
var stdin_default26 = defineComponent({
  ...
  setup(props, {
    ...
    return () => createVNode(stdin_default25, mergeProps({
      "bem": bem23,
      "role": "radio",
      "parent": parent,
      "checked": checked(),
...
var Radio = withInstall(stdin_default26);

// node_modules/vant/es/address-list/AddressListItem.mjs
var [name25, bem24] = createNamespace("address-item");
...
var [name26, bem25, t4] = createNamespace("address-list");
...
var stdin_default28 = defineComponent({
  ...
  setup(props, {
    ...
    const renderItem = (item, index, disabled) => {
      ...
      return createVNode(stdin_default27, {
        "key": item.id,
        "address": item,
        "disabled": disabled,
...
var AddressList = withInstall(stdin_default28);
...
var [name27, bem26] = createNamespace("back-top");
var backTopProps = {
  right: numericProp,
  bottom: numericProp,
...
var BackTop = withInstall(stdin_default29);

// node_modules/vant/es/calendar/utils.mjs
var [name28, bem27, t5] = createNamespace("calendar");
...
var [name29] = createNamespace("calendar-day");
...
var [name30] = createNamespace("calendar-month");
...
var [name31] = createNamespace("calendar-header");
...
var [name32, bem28] = createNamespace("image");
var imageProps = {
  src: String,
  alt: String,
  fit: String,
...
var [name33, bem29] = createNamespace("card");
var cardProps = {
  tag: String,
  num: numericProp,
  desc: String,
...
var [name34, bem30, t6] = createNamespace("cascader");
var cascaderProps = {
  title: String,
  options: makeArrayProp(),
  closeable: truthProp,
...
var stdin_default36 = defineComponent({
  ...
  setup(props, {
    ...
    const renderHeader = () => props.showHeader ? createVNode("div", {
      ...
      "name": props.closeIcon,
      "class": [bem30("close-icon"), HAPTICS_FEEDBACK],
      "onClick": onClose
    }, null) : null]) : null;
...
var Cascader = withInstall(stdin_default36);

// node_modules/vant/es/cell-group/CellGroup.mjs
var [name35, bem31] = createNamespace("cell-group");
var cellGroupProps = {
  title: String,
  inset: Boolean,
  border: truthProp
...
var CellGroup = withInstall(stdin_default37);

// node_modules/vant/es/checkbox-group/CheckboxGroup.mjs
var [name36, bem32] = createNamespace("checkbox-group");
...
var CHECKBOX_GROUP_KEY = Symbol(name36);
...
var [name37, bem33] = createNamespace("checkbox");
...
var Checkbox = withInstall(stdin_default39);

// node_modules/vant/es/checkbox-group/index.mjs
var CheckboxGroup = withInstall(stdin_default38);

// node_modules/vant/es/circle/Circle.mjs
var [name38, bem34] = createNamespace("circle");
var uid = 0;
...
var Circle = withInstall(stdin_default40);

// node_modules/vant/es/row/Row.mjs
var [name39, bem35] = createNamespace("row");
var ROW_KEY = Symbol(name39);
var rowProps = {
  tag: makeStringProp("div"),
  wrap: truthProp,
  align: String,
...
var [name40, bem36] = createNamespace("col");
var colProps = {
  tag: makeStringProp("div"),
...
var Col = withInstall(stdin_default42);

// node_modules/vant/es/collapse/Collapse.mjs
var [name41, bem37] = createNamespace("collapse");
var COLLAPSE_KEY = Symbol(name41);
var collapseProps = {
  border: truthProp,
  accordion: Boolean,
  modelValue: {
...
var Collapse = withInstall(stdin_default43);

// node_modules/vant/es/collapse-item/CollapseItem.mjs
var [name42, bem38] = createNamespace("collapse-item");
...
var CollapseItem = withInstall(stdin_default44);
...
var [name43, bem39, t7] = createNamespace("contact-card");
...
var stdin_default45 = defineComponent({
  ...
  setup(props, {
    ...
    return () => createVNode(Cell, {
      ...
      "class": bem39([props.type]),
      "border": false,
      "isLink": props.editable,
      "titleClass": bem39("title"),
      "onClick": onClick
    }, {
      title: renderContent
    });
...
var ContactCard = withInstall(stdin_default45);

// node_modules/vant/es/contact-edit/ContactEdit.mjs
var [name44, bem40, t8] = createNamespace("contact-edit");
var DEFAULT_CONTACT = {
  tel: "",
  name: ""
};
...
var ContactEdit = withInstall(stdin_default46);

// node_modules/vant/es/contact-list/ContactList.mjs
var [name45, bem41, t9] = createNamespace("contact-list");
...
var stdin_default47 = defineComponent({
  ...
  setup(props, {
    ...
    return () => createVNode("div", {
      ...
      "class": [bem41("bottom"), "van-safe-area-bottom"]
    }, [createVNode(Button, {
      "round": true,
      "block": true,
      "type": "primary",
...
var ContactList = withInstall(stdin_default47);
...
var [name46, bem42] = createNamespace("count-down");
var countDownProps = {
...
var CountDown = withInstall(stdin_default48);
...
var [name47, bem43, t10] = createNamespace("coupon");
...
var Coupon = withInstall(stdin_default49);

// node_modules/vant/es/coupon-cell/CouponCell.mjs
var [name48, bem44, t11] = createNamespace("coupon-cell");
var couponCellProps = {
  title: String,
  border: truthProp,
  editable: truthProp,
...
var CouponCell = withInstall(stdin_default50);

// node_modules/vant/es/empty/Empty.mjs
var [name49, bem45] = createNamespace("empty");
var emptyProps = {
...
var Empty = withInstall(stdin_default51);

// node_modules/vant/es/coupon-list/CouponList.mjs
var [name50, bem46, t12] = createNamespace("coupon-list");
var couponListProps = {
  code: makeStringProp(""),
  coupons: makeArrayProp(),
  currency: makeStringProp("\xA5"),
...
var CouponList = withInstall(stdin_default52);

// node_modules/vant/es/date-picker/DatePicker.mjs
var currentYear = new Date().getFullYear();
var [name51] = createNamespace("date-picker");
...
var DatePicker = withInstall(stdin_default53);

// node_modules/vant/es/divider/Divider.mjs
var [name52, bem47] = createNamespace("divider");
var dividerProps = {
  dashed: Boolean,
  hairline: truthProp,
...
var Divider = withInstall(stdin_default54);

// node_modules/vant/es/dropdown-menu/DropdownMenu.mjs
var [name53, bem48] = createNamespace("dropdown-menu");
...
var DROPDOWN_KEY = Symbol(name53);
...
var [name54, bem49] = createNamespace("dropdown-item");
...
var DropdownItem = withInstall(stdin_default56);

// node_modules/vant/es/dropdown-menu/index.mjs
var DropdownMenu = withInstall(stdin_default55);

// node_modules/vant/es/grid/Grid.mjs
var [name55, bem50] = createNamespace("grid");
var gridProps = {
  square: Boolean,
  center: truthProp,
  border: truthProp,
...
var Grid = withInstall(stdin_default57);

// node_modules/vant/es/grid-item/GridItem.mjs
var [name56, bem51] = createNamespace("grid-item");
...
var stdin_default58 = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      const classes = [bem51("content", [direction, {
        center,
        square,
        reverse,
        clickable,
...
var GridItem = withInstall(stdin_default58);
...
var bem52 = createNamespace("image-preview")[1];
var stdin_default59 = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      return createVNode(SwipeItem, {
        "ref": swipeItem,
        "class": bem52("swipe-item"),
        "onTouchstartPassive": onTouchStart,
        "onTouchend": onTouchEnd,
        "onTouchcancel": onTouchEnd
      }, {
        default: () => [slots.image ? createVNode("div", {
          "class": bem52("image-wrap")
        }, [slots.image({
          src: props.src
        })]) : createVNode(Image2, {
          "src": props.src,
...
var [name57, bem53] = createNamespace("image-preview");
...
var stdin_default60 = defineComponent({
  ...
  setup(props, {
    ...
    const renderImages = () => createVNode(Swipe, {
      ...
      default: () => [props.images.map((image, index) => createVNode(stdin_default59, {
        "src": image,
        "show": props.show,
        "active": state.active,
    ...
    const renderClose = () => {
      if (props.closeable) {
        return createVNode(Icon, {
          "role": "button",
          "name": props.closeIcon,
          "class": [bem53("close-icon", props.closeIconPosition), HAPTICS_FEEDBACK],
          "onClick": emitClose
        }, null);
      }
    };
    ...
    return () => createVNode(Popup, mergeProps({
      "class": [bem53(), props.className],
      "overlayClass": [bem53("overlay"), props.overlayClass],
      "onClosed": onClosed,
      "onUpdate:show": updateShow
...
function initInstance() {
  ({
    ...
    setup() {
      ...
      return () => createVNode(stdin_default60, mergeProps(state, {
        "onClosed": onClosed,
        "onUpdate:show": toggle
      }), null);
    }
...
var ImagePreview = withInstall(stdin_default60);
...
var [name58, bem54] = createNamespace("index-bar");
var indexBarProps = {
  sticky: truthProp,
  zIndex: numericProp,
  teleport: [String, Object],
...
var INDEX_BAR_KEY = Symbol(name58);
...
var [name59, bem55] = createNamespace("index-anchor");
...
var IndexAnchor = withInstall(stdin_default62);

// node_modules/vant/es/index-bar/index.mjs
var IndexBar = withInstall(stdin_default61);

// node_modules/vant/es/list/List.mjs
var [name60, bem56, t13] = createNamespace("list");
var listProps = {
  error: Boolean,
    ...
    const renderLoading = () => {
      if (loading.value && !props.finished && !props.disabled) {
        return createVNode("div", {
          ...
          "class": bem56("loading-icon")
        }, {
          default: () => [props.loadingText || t13("loading")]
        })]);
      }
    };
...
var List = withInstall(stdin_default63);

// node_modules/vant/es/nav-bar/NavBar.mjs
var [name61, bem57] = createNamespace("nav-bar");
var navBarProps = {
  title: String,
  fixed: Boolean,
  zIndex: numericProp,
...
var stdin_default64 = defineComponent({
  ...
  setup(props, {
    ...
    const navBarRef = ref();
    const renderPlaceholder = usePlaceholder(navBarRef, bem57);
    ...
    const renderNavBar = () => {
      ...
      return createVNode("div", {
        ...
        "class": [bem57("left"), props.clickable ? HAPTICS_FEEDBACK : ""],
        "onClick": onClickLeft
      }, [renderLeft()]), createVNode("div", {
        "class": [bem57("title"), "van-ellipsis"]
      }, [slots.title ? slots.title() : title]), hasRight && createVNode("div", {
        "class": [bem57("right"), props.clickable ? HAPTICS_FEEDBACK : ""],
...
var NavBar = withInstall(stdin_default64);

// node_modules/vant/es/notice-bar/NoticeBar.mjs
var [name62, bem58] = createNamespace("notice-bar");
var noticeBarProps = {
  text: String,
  mode: String,
  color: String,
...
var NoticeBar = withInstall(stdin_default65);

// node_modules/vant/es/notify/Notify.mjs
var [name63, bem59] = createNamespace("notify");
...
var stdin_default66 = defineComponent({
  ...
  setup(props, {
    ...
    return () => createVNode(Popup, {
      "show": props.show,
      "class": [bem59([props.type]), props.className],
      "style": {
        color: props.color,
        background: props.background
      },
...
function initInstance2() {
  ({
    ...
    setup() {
      ...
      return () => createVNode(stdin_default66, mergeProps(state, {
        "onUpdate:show": toggle
      }), null);
    }
  }));
...
var Notify = withInstall(stdin_default66);

// node_modules/vant/es/number-keyboard/NumberKeyboardKey.mjs
var [name64, bem60] = createNamespace("key");
var CollapseIcon = createVNode("svg", {
  "class": bem60("collapse-icon"),
  "viewBox": "0 0 30 24"
}, [createVNode("path", {
...
var [name65, bem61] = createNamespace("number-keyboard");
...
var stdin_default68 = defineComponent({
  ...
  setup(props, {
    ...
    const renderKeys = () => keys.value.map((key) => {
      ...
      return createVNode(stdin_default67, {
        "key": key.text,
        "text": key.text,
        "type": key.type,
        "wider": key.wider,
    ...
    const renderSidebar = () => {
      if (props.theme === "custom") {
        return createVNode("div", {
          "class": bem61("sidebar")
        }, [props.showDeleteKey && createVNode(stdin_default67, {
          "large": true,
...
var NumberKeyboard = withInstall(stdin_default68);

// node_modules/vant/es/pagination/Pagination.mjs
var [name66, bem62, t14] = createNamespace("pagination");
...
var stdin_default69 = defineComponent({
  ...
  setup(props, {
    ...
    const renderPrevButton = () => {
      ...
      }, [slot ? slot() : props.prevText || t14("prev")])]);
    };
    const renderNextButton = () => {
      ...
      return createVNode("li", {
        ...
        "disabled": disabled,
        "onClick": () => updateModelValue(modelValue + 1, true)
      }, [slot ? slot() : props.nextText || t14("next")])]);
    };
...
var Pagination = withInstall(stdin_default69);

// node_modules/vant/es/password-input/PasswordInput.mjs
var [name67, bem63] = createNamespace("password-input");
  ...
  setup(props, {
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        "class": [bem63("security"), {
          [BORDER_SURROUND]: !props.gutter
        }],
        "onTouchstartPassive": onTouchStart
      }, [renderPoints()]), info && createVNode("div", {
        "class": bem63(props.errorInfo ? "error-info" : "info")
      }, [info])]);
    };
  }
});
...
var PasswordInput = withInstall(stdin_default70);

// node_modules/vant/es/picker-group/index.mjs
var PickerGroup = withInstall(stdin_default12);
  ...
  return function createPopper2(reference, popper, options) {
    ...
    var instance3 = {
      ...
      setOptions: function setOptions(setOptionsAction) {
        ...
        if (true) {
          var modifiers = uniqueBy([].concat(orderedModifiers, state.options.modifiers), function(_ref) {
            var name93 = _ref.name;
            return name93;
          });
          validateModifiers(modifiers);
          if (getBasePlacement(state.options.placement) === auto) {
            var flipModifier = state.orderedModifiers.find(function(_ref2) {
              var name93 = _ref2.name;
              return name93 === "flip";
            });
            if (!flipModifier) {
      ...
      forceUpdate: function forceUpdate() {
        ...
        for (var index = 0; index < state.orderedModifiers.length; index++) {
          ...
          var _state$orderedModifie = state.orderedModifiers[index], fn2 = _state$orderedModifie.fn, _state$orderedModifie2 = _state$orderedModifie.options, _options = _state$orderedModifie2 === void 0 ? {} : _state$orderedModifie2, name93 = _state$orderedModifie.name;
    ...
    function runModifierEffects() {
      state.orderedModifiers.forEach(function(_ref3) {
        var name93 = _ref3.name, _ref3$options = _ref3.options, options2 = _ref3$options === void 0 ? {} : _ref3$options, effect3 = _ref3.effect;
...
function popperOffsets(_ref) {
  var state = _ref.state, name93 = _ref.name;
  state.modifiersData[name93] = computeOffsets({
...
function applyStyles(_ref) {
  ...
  Object.keys(state.elements).forEach(function(name93) {
    var style = state.styles[name93] || {};
    var attributes = state.attributes[name93] || {};
    var element = state.elements[name93];
...
function effect2(_ref2) {
  ...
  return function() {
    Object.keys(state.elements).forEach(function(name93) {
      var element = state.elements[name93];
      var attributes = state.attributes[name93] || {};
      var styleProperties = Object.keys(state.styles.hasOwnProperty(name93) ? state.styles[name93] : initialStyles[name93]);
...
function offset(_ref2) {
  var state = _ref2.state, options = _ref2.options, name93 = _ref2.name;
  ...
  state.modifiersData[name93] = data;
}
var offset_default = {
  name: "offset",
  enabled: true,
...
var [name68, bem64] = createNamespace("popover");
var popupProps2 = ["overlay", "duration", "teleport", "overlayStyle", "overlayClass", "closeOnClickOverlay"];
var popoverProps = {
  show: Boolean,
  ...
  setup(props, {
    ...
    const renderActionContent = (action, index) => {
      ...
      return [action.icon && createVNode(Icon, {
        "name": action.icon,
        "classPrefix": props.iconPrefix,
        "class": bem64("action-icon")
      }, null), createVNode("div", {
        "class": [bem64("action-text"), BORDER_BOTTOM]
      }, [action.text])];
    };
    const renderAction = (action, index) => {
      const {
    ...
    return () => {
      ...
      return createVNode(Fragment, null, [createVNode("span", {
        ...
        "ref": popoverRef,
        "show": show.value,
        "class": bem64([props.theme]),
        "position": "",
        "transition": "van-popover-zoom",
        "lockScroll": false,
        "onUpdate:show": updateShow
      }, attrs, pick(props, popupProps2)), {
...
var Popover = withInstall(stdin_default71);

// node_modules/vant/es/progress/Progress.mjs
var [name69, bem65] = createNamespace("progress");
var progressProps = {
  color: String,
  inactive: Boolean,
  pivotText: String,
...
var Progress = withInstall(stdin_default72);

// node_modules/vant/es/pull-refresh/PullRefresh.mjs
var [name70, bem66, t15] = createNamespace("pull-refresh");
...
var stdin_default73 = defineComponent({
  ...
  setup(props, {
    ...
    const getStatusText = () => {
      ...
      return props[`${status}Text`] || t15(status);
    };
    const renderStatus = () => {
      const {
        status,
...
var PullRefresh = withInstall(stdin_default73);

// node_modules/vant/es/rate/Rate.mjs
var [name71, bem67] = createNamespace("rate");
...
var Rate = withInstall(stdin_default74);

// node_modules/vant/es/row/index.mjs
var Row = withInstall(stdin_default41);

// node_modules/vant/es/search/Search.mjs
var [name72, bem68, t16] = createNamespace("search");
...
var stdin_default75 = defineComponent({
  ...
  setup(props, {
    ...
    const renderAction = () => {
      if (props.showAction) {
        const text = props.actionText || t16("cancel");
        return createVNode("div", {
          "class": bem68("action"),
          "role": "button",
          "tabindex": 0,
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        "class": bem68("content", props.shape)
...
var Search = withInstall(stdin_default75);
...
var [name73, bem69, t17] = createNamespace("share-sheet");
...
var stdin_default76 = defineComponent({
  ...
  setup(props, {
    ...
    const renderCancelButton = () => {
      var _a;
      const cancelText = (_a = props.cancelText) != null ? _a : t17("cancel");
...
var ShareSheet = withInstall(stdin_default76);

// node_modules/vant/es/sidebar/Sidebar.mjs
var [name74, bem70] = createNamespace("sidebar");
var SIDEBAR_KEY = Symbol(name74);
var sidebarProps = {
...
var Sidebar = withInstall(stdin_default77);

// node_modules/vant/es/sidebar-item/SidebarItem.mjs
var [name75, bem71] = createNamespace("sidebar-item");
...
var SidebarItem = withInstall(stdin_default78);

// node_modules/vant/es/skeleton/SkeletonTitle.mjs
var [name76, bem72] = createNamespace("skeleton-title");
...
var [name77, bem73] = createNamespace("skeleton-avatar");
...
var [name78, bem74] = createNamespace("skeleton-paragraph");
...
var [name79, bem75] = createNamespace("skeleton");
...
var stdin_default82 = defineComponent({
  ...
  setup(props, {
    ...
    const renderAvatar = () => {
      if (props.avatar) {
        return createVNode(stdin_default80, {
    ...
    const renderRows = () => Array(+props.row).fill("").map((_, i) => createVNode(stdin_default81, {
      "key": i,
      "round": props.round,
...
var [name80, bem76] = createNamespace("skeleton-image");
...
var SkeletonImage = withInstall(stdin_default83);
var SkeletonTitle = withInstall(stdin_default79);
var SkeletonAvatar = withInstall(stdin_default80);
var SkeletonParagraph = withInstall(stdin_default81);
var Skeleton = withInstall(stdin_default82);

// node_modules/vant/es/slider/Slider.mjs
var [name81, bem77] = createNamespace("slider");
var sliderProps = {
  ...
  setup(props, {
    ...
    const getButtonClassName = (index) => {
      if (typeof index === "number") {
        ...
        return bem77(`button-wrapper`, position[index]);
      }
      return bem77("button-wrapper", props.reverse ? "left" : "right");
    };
...
var Slider = withInstall(stdin_default84);

// node_modules/vant/es/space/Space.mjs
var [name82, bem78] = createNamespace("space");
var spaceProps = {
  align: String,
  direction: {
    type: String,
...
var Space = withInstall(stdin_default85);

// node_modules/vant/es/steps/Steps.mjs
var [name83, bem79] = createNamespace("steps");
var stepsProps = {
  active: makeNumericProp(0),
...
var [name84, bem80] = createNamespace("step");
var stdin_default87 = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      return createVNode("div", {
        "class": [BORDER, bem80([parentProps.direction, {
          [status]: status
        }])]
      }, [createVNode("div", {
        "class": bem80("title", {
...
var Step = withInstall(stdin_default87);

// node_modules/vant/es/stepper/Stepper.mjs
var [name85, bem81] = createNamespace("stepper");
...
var Stepper = withInstall(stdin_default88);

// node_modules/vant/es/steps/index.mjs
var Steps = withInstall(stdin_default86);

// node_modules/vant/es/submit-bar/SubmitBar.mjs
var [name86, bem82, t18] = createNamespace("submit-bar");
var submitBarProps = {
  tip: String,
  label: String,
  price: Number,
...
var stdin_default89 = defineComponent({
  ...
  setup(props, {
    ...
    const root = ref();
    const renderPlaceholder = usePlaceholder(root, bem82);
    const renderText = () => {
      const {
        price,
        label,
      ...
      if (typeof price === "number") {
        ...
        }, [createVNode("span", null, [label || t18("label")]), createVNode("span", {
          "class": bem82("price")
        }, [currency, createVNode("span", {
          "class": bem82("price-integer")
        }, [pricePair[0]]), decimal]), suffixLabel && createVNode("span", {
          "class": bem82("suffix-label")
        }, [suffixLabel])]);
      }
    };
    const renderTip = () => {
      ...
      if (slots.tip || tip) {
        return createVNode("div", {
          ...
          "class": bem82("tip-icon"),
          "name": tipIcon
        }, null), tip && createVNode("span", {
          "class": bem82("tip-text")
    ...
    const renderButton = () => {
      ...
      return createVNode(Button, {
        ...
        "class": bem82("button", props.buttonType),
...
var SubmitBar = withInstall(stdin_default89);

// node_modules/vant/es/swipe-cell/SwipeCell.mjs
var [name87, bem83] = createNamespace("swipe-cell");
var swipeCellProps = {
  name: makeNumericProp(""),
  disabled: Boolean,
...
var SwipeCell = withInstall(stdin_default90);

// node_modules/vant/es/tabbar/Tabbar.mjs
var [name88, bem84] = createNamespace("tabbar");
var tabbarProps = {
  route: Boolean,
  fixed: truthProp,
  border: truthProp,
...
var stdin_default91 = defineComponent({
  ...
  setup(props, {
    ...
    const renderPlaceholder = usePlaceholder(root, bem84);
...
var Tabbar = withInstall(stdin_default91);

// node_modules/vant/es/tabbar-item/TabbarItem.mjs
var [name89, bem85] = createNamespace("tabbar-item");
...
var TabbarItem = withInstall(stdin_default92);

// node_modules/vant/es/time-picker/TimePicker.mjs
var [name90] = createNamespace("time-picker");
...
var TimePicker = withInstall(stdin_default93);

// node_modules/vant/es/tree-select/TreeSelect.mjs
var [name91, bem86] = createNamespace("tree-select");
var treeSelectProps = {
  max: makeNumericProp(Infinity),
  items: makeArrayProp(),
  ...
  setup(props, {
    ...
    const renderSidebar = () => {
      const Items = props.items.map((item) => createVNode(SidebarItem, {
        ...
        "title": item.text,
        "badge": item.badge,
        "class": [bem86("nav-item"), item.className],
        "disabled": item.disabled,
...
var TreeSelect = withInstall(stdin_default94);

// node_modules/vant/es/uploader/utils.mjs
var [name92, bem87, t19] = createNamespace("uploader");
  ...
  setup(props, {
    ...
    const renderDeleteIcon = () => {
      if (props.deletable && props.item.status !== "uploading") {
        ...
        return createVNode("div", {
          "role": "button",
          "class": bem87("preview-delete", {
            shadow: !slot
          }),
          "tabindex": 0,
          "aria-label": t19("delete"),
          "onClick": onDelete
        }, [slot ? slot() : createVNode(Icon, {
          "name": "cross",
          "class": bem87("preview-delete-icon")
        }, null)]);
      }
    };
    const renderCover = () => {
    ...
    const renderPreview = () => {
      ...
      return createVNode("div", {
        ...
        "class": bem87("file-icon"),
        "name": "description"
      }, null), createVNode("div", {
        "class": [bem87("file-name"), "van-ellipsis"]
...
var stdin_default96 = defineComponent({
  ...
  setup(props, {
    ...
    const renderPreviewItem = (item, index) => {
      ...
      return createVNode(stdin_default95, mergeProps({
        "item": item,
        "index": index,
    ...
    const renderUpload = () => {
      ...
      return withDirectives(createVNode("div", {
        ...
        "class": bem87("upload-icon")
      }, null), props.uploadText && createVNode("span", {
        "class": bem87("upload-text")
...
var Uploader = withInstall(stdin_default96);
...
var stdin_default99 = (lazyManager) => ({
  props: {
    src: [String, Object],
    tag: {
      type: String,
...
var Lazyload = {
  install(app, options = {}) {
    const LazyClass = stdin_default97();
    const lazy = new LazyClass(options);
    const lazyContainer = new LazyContainerManager({ lazy });
    app.config.globalProperties.$Lazyload = lazy;
    if (options.lazyComponent) {
      app.component("LazyComponent", stdin_default98(lazy));
    }
    if (options.lazyImage) {
      app.component("LazyImage", stdin_default99(lazy));
    }
    app.directive("lazy", {
...
export {
  ...
  version,
  install,
  stdin_default100 as stdin_default
};
//# sourceMappingURL=chunk-USKC5K5K.js.map
